const funIndexPage = () => {
    if (document.querySelectorAll("#meta > h3.style-scope.ytd-rich-grid-media").length >= 5) {
        document.querySelectorAll("#meta > h3.style-scope.ytd-rich-grid-media").forEach(element => {
