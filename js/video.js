const funVideoPage = () => {
    if (document.querySelectorAll("#dismissible > div.details > div.metadata").length >= 5) {
        document.querySelectorAll("#dismissible > div.details > div.metadata").forEach(element => {
            ...
            const title = element.querySelector("a > h3 > span#video-title").title;
